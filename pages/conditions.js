    ...
    <Container mb={16} maxW={'4xl'}>
      ...
      <UnorderedList fontSize="xl" spacing={3}>
        ...
        <ListItem>
          ...
          المستخدم يقوم بمحاولن الاحتيال علينا أو إنتهاك سياسة الموقع مهما كانت الظروف او الاسباب
          ولا يوجد استثناءات نهائيا بذلك.
        </ListItem>
        <ListItem>
      ...
      <List fontSize="xl" spacing={3}>
        ...
        <ListItem>
          ...
          فعليه مراسلتنا عبر رابط صفحة الاتصال في اسفل الموقع لحل المشكلة. – يلتزم المستخدم بوضع
          صورته الشخصية الحقيقية وعدم وضع صورة لشخص آخر ضمن حسابه، أو صور ترويجية.
        </ListItem>
        <ListItem>
