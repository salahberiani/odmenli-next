...
const questions = [
  ...
  {
    q: 'كم من الوقت يلزم لكم لارسال الأموال بعد انتهاء الصفقة؟',
    a: 'يتم التأكد جيدا من اتمام الصفقة ثم بعد ذلك في اليوم نفسه يتم الارسال واذا لم يتم الارسال في اليوم ذاته ففي اليوم التالي كأقصى حد',
  },
];
